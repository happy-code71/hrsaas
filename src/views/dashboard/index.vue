<template>
  <div class="dashboard-container">
    ...
    <el-dialog :visible.sync="showDialog" title="离职申请" @close="btnCancel">
      <el-form :rules="rules" label-width="120px" :model="ruleForm" ref="ruleForm">
        <el-form-item label="申请类型">
          <el-select v-model="ruleForm.processName">
            <el-option label="离职" value="ruleForm.processName"></el-option>
          </el-select>
        </el-form-item>

        <el-form-item label="期望离职时间" prop="exceptTime">
          <el-date-picker type="datetime" placeholder="选择日期时间" v-model="ruleForm.exceptTime"
            value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
        </el-form-item>

        <el-form-item label="离职原因" prop="reason">
          <el-input type="textarea" style="width: 70%;" :rows="3" v-model="ruleForm.reason"></el-input>
        </el-form-item>
      </el-form>
