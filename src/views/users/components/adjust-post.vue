  ...
  <div class="AdjustThePost">
    ...
    <div>
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="110px" class="demo-ruleForm">
        <el-form-item v-for="(item, index) in ruleForm.items" :key="index"
          :label="item.type == 'img' ? '附件' : item.title" prop="types">
          <span v-if="item.oldValue != ''">
            <el-input v-model="item.oldValue" style="width: 220px;" /><span class="Label">-></span>
